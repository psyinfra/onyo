...
def test_history_config_unset(repo: OnyoRepo) -> None:
    ...
    repo.git.add(".onyo/config")
    repo.git.commit("Unset in .onyo/config: 'onyo.history.non-interactive'")
...
def test_history_config_invalid(repo: OnyoRepo) -> None:
    ...
    repo.git.add(".onyo/config")
    repo.git.commit("Set non-existing: 'onyo.history.non-interactive'")
...
def test_history_fake_noninteractive_stdout(repo: OnyoRepo, asset: str) -> None:
    ...
    repo.git.add(".onyo/config")
    repo.git.commit("Update config: 'onyo.history.non-interactive'")
