...
@params({
    f'{length} x {num}': {'variant': (length, num)} for length in random.sample(range(4, 20), 10) for num in random.sample(range(1, 10000), 5)
})
...
@params({
    f'{length} x {num}': {'variant': (length, num)} for length in range(-2, 4) for num in random.sample(range(1, 10000), 5)
})
...
@params({
    f'{length} x {num}': {"variant": (length, num)} for length in random.sample(range(4, 20), 5) for num in range(-2, 1)
})
...
@params({
    f'{length} x {num}': {'variant': (length, num)} for length in range(0, 4) for num in range(-2, 1)
})
