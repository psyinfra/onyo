...
class TestClass:
    ...
    test_commands = [
        ...
        ("onyo mv shelf/laptop_apple_macbookpro.2 user/", "", "empty_file.txt"),
        ("onyo mv shelf/laptop_apple_macbookpro.3 user/laptop_apple_macbookpro.3", "", "empty_file.txt"),
        ...
        ("onyo mv 'user 2' 'no user'", "", "empty_file.txt"),
