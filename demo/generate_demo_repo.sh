...
onyo get --match type=laptop --machine-readable --keys path | xargs -d "\n" onyo --yes set --keys USB_A=2 --asset

# specify the number of USB ports (type A and C) on MacBooks
onyo get --match model=macbook --machine-readable --keys path | xargs -d "\n" onyo --yes set --keys USB_A=2 USB_C=1 --asset
